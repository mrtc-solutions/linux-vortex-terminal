#compdef vortex
_vortex() {
  _arguments '1:command:(ask plan run doctor tools adapters artifact backup db migrate shell engagement history explain undo session config model knowledge completion report theme)' '*::arg:->args'
  case "$words[2]" in
