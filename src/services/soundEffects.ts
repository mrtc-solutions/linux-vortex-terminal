class SoundEffectsManager {
  ...
  constructor() {
    // Check localStorage
    const saved = localStorage.getItem('vortex_muted');
    if (saved !== null) {
  ...
  public toggleMute(): boolean {
    ...
    localStorage.setItem('vortex_muted', String(this.isMuted));
    return this.isMuted;
  }
  ...
  public playExecute() {
    ...
    try {
      ...
      osc.frequency.exponentialRampToValueAtTime(1240, this.ctx.currentTime + 0.08);
